...
if (isset($_GET['id'])) {
    ...
    $getUserResponse = POSTDataJSON($dataJson, "Form/DeleteForm/", $token);
    if ($getUserResponse->HTTPResponseCode == 200) {
        ...
        if ($response->ResponseCode == 0) {
            ...
            header('location:daftar-form.php');
        ...
        $getUserResponseNew = POSTDataJSON($dataJson, "Form/DeleteForm/", $newToken);
