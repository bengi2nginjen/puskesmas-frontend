        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Buat Form</h1>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-7">
                            <div class="user" id="pertanyaan">
                                <div>
                                    <input type="text" class="form-control form-control-user" id="form-title" placeholder="Judul Form">
                                </div>
                                <div class="button-flex-container mt-3">
                                    <textarea type="text" class="form-control form-control-user" id="form-description" placeholder="Deskripsi Form"></textarea>
                                </div>
                                ...
                                <div>
                                    <div class="button-flex-container mt-3">
                                        ...
                                        <button id="add-question" class='btn btn-success btn-circle ml-2 mr-2'>
                                            <i class='fas fa-plus'></i>
                                        </button>
                                        <span class="divider">
                                        </span>
                                ...
                                <div class="button-flex-container mt-3">
                                    <button id="submit-form" href="#" class="form-control btn btn-primary btn-icon-split">
