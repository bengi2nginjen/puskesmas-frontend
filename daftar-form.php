            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Daftar Form</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        if ($forms != null) {
                            foreach ($forms as $form) {
                                ...
                                echo '<a href="isi-form.php?id='.$form->id.'">';
                                echo '<div class="card-body">';
                                echo '<div class="row no-gutters align-items-center">';
                                echo '<div class="col mr-2">';
                                echo '<div class="h2 text-xs font-weight-bold text-info text-uppercase mb-1 ">';
                                echo '<h5 class="h5">'.$form->name;
                                echo '</h5>';
                                echo '</div>';
                                echo '</div>';
                                echo '</div>';
